...
fs.readFile(someFile, 'utf8', function(err, data) {
    ...
    result = result.replace('return win[\'__zone_symbol__requestAnimationFrame\'](callback);', 'if (typeof win[\'__zone_symbol__requestAnimationFrame\']=== \'undefined\') { return; } return win[\'__zone_symbol__requestAnimationFrame\'](callback);');
